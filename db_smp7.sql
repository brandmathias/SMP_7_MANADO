...
: 127.0.0.1
-- Waktu pembuatan: 26 Apr 2024 pada 08.16
...
(5, '::1', 'admin@gmail.com', 1714020242);
...
(7, 2, 'Progres', 'progres', 'fas fa-fw fa-home', 'Y'),
(8, 2, 'Prestasi Guru', 'prestasiguru', 'fas fa-fw fa-home', 'Y');
...
(1, '127.0.0.1', 'administrator', '$2y$12$pfe4X24wUalRwJseC96pLOh2FshRtmYVNRhS8eLTKCSv9KVXRWxBy', 'admin@mail.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1714092323, 1, 'Abid', 'Taufiqur R.', NULL, '081222332442');
